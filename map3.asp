          ...
          <tbody>
           <tr> 
            <td width="65%" align="center" valign="top"><table border="1" cellspacing="0" cellpadding="0">
              <tr> 
               <td><div id="map" style="width: 480px; height: 500px"></div></td>
              </tr>
             </table></td>
            <td width="35%" align="center" valign="top"><p align="left">Mailing Address:</p>
             <blockquote> 
              <p class="header">Order of the Eastern Star <br>
               1503 East Division<br>
             ...
             <p align="left"><br>
              ...
              Grand Secretary:</p>
             <blockquote> 
              <p align="left"><strong>Phone Number: 817-265-6263 <br>
               FAX Line: 817-274-5995</strong></p>
             </blockquote>
...
<script type="text/javascript">
   ...
   var WINDOW_HTML = '<div style="width: 12em; style: font-size: small">Grand Chapter Office<br>1111 East Division<br>Arlington, Texas 76011.</div>';
    ...
    function loadMap() {
      ...
      map.centerAndZoom(new GPoint(-097.094987, 32.7413), 4);
      var marker = new GMarker(new GPoint(-097.094987, 32.7413));
